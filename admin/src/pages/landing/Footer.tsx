...
import logoDark from '../../assets/images/Voluntarius-Logo.png';
import logoLight from '../../assets/images/Voluntarius-Logo.png';
        ...
        <footer className="pt-5 pb-3 position-relative" style={{ background: `url(${backImg}) center top` }}>
            ...
            <Container>
                <Row className="justify-content-between">
                    <Col md={6}>
                        ...
                        <p className="fs-15 mt-4">
                            Voluntarius makes it easier to build better websites with
                ...
                <Row>
                    <Col lg={12}>
                        <div className="mt-5">
                            <p className="mt-4 text-center mb-0">© {new Date().getFullYear()} Voluntarius. Design and coded by Coderthemes</p>
                        </div>
                    </Col>
                </Row>
            </Container>
