            ...
            <Container>
                <Row className="align-items-center">
                    <Col className="text-center">
                        <div className="py-4">
                            <h1 className="mb-4">Build your dashboard or admin application faster with Voluntarius</h1>

                            <p className="mb-3 fs-16 text-center">
                                Voluntarius is a fully featured admin and dashboard template. Voluntarius comes with tones of well
